...
cp /data2/text_simplification/dataset/train/* /data2/text_simplification/dataset/valid/* data/newsela_Zhang_Lapata_splits
...
bash $rootdir/scripts/train-embeddings.sh -p $hyperparam_file -e sockeye_gpu
